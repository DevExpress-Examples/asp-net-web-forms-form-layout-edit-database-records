...
<%@ Register Assembly="DevExpress.Web.v13.1, Version=13.1.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxFormLayout" TagPrefix="dx" %>
...
<%@ Register Assembly="DevExpress.Web.v13.1, Version=13.1.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxPager" TagPrefix="dx" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dx:ASPxPager ID="ASPxPager1" runat="server" RenderMode="Lightweight" OnPageIndexChanging="ASPxPager1_PageIndexChanging" ItemsPerPage="1" OnInit="ASPxPager1_Init">
